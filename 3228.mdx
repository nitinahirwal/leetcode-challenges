---
title: LeetCode Challenge Day 59 — 3228. Maximum Number of Operations to Move Ones to the End  
summary: Day 59 of my LeetCode challenge! Today’s problem is "3228. Maximum Number of Operations to Move Ones to the End" — a clever greedy + counting problem based on zero-block structure in a binary string.  
solution: https://leetcode.com/problems/maximum-number-of-operations-to-move-ones-to-the-end/solutions/7346409/3228-maximum-number-of-operations-to-mov-lk52
image:  
